...
public class LoginUserTests : BaseFunctionalTest
{
    ...
    public async Task Login_ShouldReturnUnauthorized_WhenUserDoesNotExist()
    {
        ...
        // Act
        var response = await this.httpClient.PostAsJsonAsync("api/v1/users/login", request);
    ...
    public async Task Login_ShouldReturnOk_WhenUserExists()
    {
        ...
        await this.httpClient.PostAsJsonAsync("api/v1/users/register", registerRequest);
